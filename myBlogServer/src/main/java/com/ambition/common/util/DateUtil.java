...
public class DateUtil {
    ...
    /**
     * 2016-11-10 07:33:23, 则返回2016-11-30 23:59:59.999 注意:入库的时候会导致进位
     */
    ...
    /**
     * 2016-11-10 07:33:23, 则返回2016-11-30 23:59:59
     */
    public static Date endOfMonthSecond(@NotNull final Date date) {
        return new Date(nextMonth(date).getTime() - 1000);
    }
    ...
    /**
     * 2017-1-23 07:33:23, 则返回2017-1-23 23:59:59.999 注意:入库的时候会导致进位
     */
    ...
    /**
     * 2017-1-23 07:33:23, 则返回2017-1-23 23:59:59
     */
    public static Date endOfDateSecond(@NotNull final Date date) {
        return new Date(nextDate(date).getTime() - 1000);
    }
    ...
    public static long getRemainDayMill(Date date) {
        return (endOfDate(date).getTime() - System.currentTimeMillis()) / 1000;
    }

    public static boolean isTimeRange(@NotNull String beginTimes, @NotNull String endTimes) {
        SimpleDateFormat df = new SimpleDateFormat("HH:mm");
        try {
            Date now = df.parse(df.format(new Date()));
            Date begin = df.parse(beginTimes);
            Date end = df.parse(endTimes);
