 ...
 */
@RestController
@RequestMapping("/{origin}//poems-author")
public class PoemsAuthorController {

     private static final Logger LOG = LoggerFactory.getLogger(PoemsAuthorController.class);

     @Autowired
     private IPoemsAuthorService service;
    ...
    */
    ...
    @LoginedUser
    @AddSysLog(descrption = "分页查询PoemsAuthor列表")
     ...
     */
     ...
     @LoginedUser
     @AddSysLog(descrption = "根据id查询PoemsAuthor")
     ...
     */
     ...
     @LoginedUser
     @AddSysLog(descrption = "新增PoemsAuthor")
     public R save(@CurrentUser@ApiIgnore SysUser sysUser,@RequestBody @Valid PoemsAuthor entity){
        return service.savePoemsAuthor(entity);
     }
     ...
     */
     ...
     @LoginedUser
     @AddSysLog(descrption = "根据id删除PoemsAuthor")
     ...
     */
     ...
     @LoginedUser
     @AddSysLog(descrption = "更新PoemsAuthor")
     public R update(@CurrentUser@ApiIgnore SysUser sysUser,@RequestBody @Valid PoemsAuthor entity){
       return service.updatePoemsAuthorById(entity);
     }
}
