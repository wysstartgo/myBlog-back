 ...
 */
@RestController
@RequestMapping("/{origin}//poetry-info")
public class PoetryInfoController {

     private static final Logger LOG = LoggerFactory.getLogger(PoetryInfoController.class);

     @Autowired
     private IPoetryInfoService service;
    ...
    */
    ...
    @LoginedUser
    @AddSysLog(descrption = "分页查询PoetryInfo列表")
     ...
     */
     ...
     @LoginedUser
     @AddSysLog(descrption = "根据id查询PoetryInfo")
     ...
     */
     ...
     @LoginedUser
     @AddSysLog(descrption = "新增PoetryInfo")
     public R save(@CurrentUser@ApiIgnore SysUser sysUser,@RequestBody @Valid PoetryInfo entity){
        return service.savePoetryInfo(entity);
     }
     ...
     */
     ...
     @LoginedUser
     @AddSysLog(descrption = "根据id删除PoetryInfo")
     ...
     */
     ...
     @LoginedUser
     @AddSysLog(descrption = "更新PoetryInfo")
     public R update(@CurrentUser@ApiIgnore SysUser sysUser,@RequestBody @Valid PoetryInfo entity){
       return service.updatePoetryInfoById(entity);
     }
}
