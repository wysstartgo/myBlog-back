 ...
 */
@RestController
@RequestMapping("/{origin}//content-author")
public class ContentAuthorController {

     private static final Logger LOG = LoggerFactory.getLogger(ContentAuthorController.class);

     @Autowired
     private IContentAuthorService service;
    ...
    */
    ...
    @LoginedUser
    @AddSysLog(descrption = "分页查询ContentAuthor列表")
     ...
     */
     ...
     @LoginedUser
     @AddSysLog(descrption = "根据id查询ContentAuthor")
     ...
     */
     ...
     @LoginedUser
     @AddSysLog(descrption = "新增ContentAuthor")
     public R save(@CurrentUser@ApiIgnore SysUser sysUser,@RequestBody @Valid ContentAuthor entity){
        return service.saveContentAuthor(entity);
     }
     ...
     */
     ...
     @LoginedUser
     @AddSysLog(descrption = "根据id删除ContentAuthor")
     ...
     */
     ...
     @LoginedUser
     @AddSysLog(descrption = "更新ContentAuthor")
     public R update(@CurrentUser@ApiIgnore SysUser sysUser,@RequestBody @Valid ContentAuthor entity){
       return service.updateContentAuthorById(entity);
     }
}
