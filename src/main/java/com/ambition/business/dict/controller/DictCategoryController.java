...
public class DictCategoryController {
     ...
     private static final Logger LOG = LoggerFactory.getLogger(DictCategoryController.class);
    ...
    */
    ...
    @LoginedUser
    @AddSysLog(descrption = "分页查询DictCategory列表")
     ...
     */
     ...
     @LoginedUser
     @AddSysLog(descrption = "根据id查询DictCategory")
     ...
     */
     ...
     @LoginedUser
     @AddSysLog(descrption = "根据id删除DictCategory")
     ...
     */
     ...
     @LoginedUser
     @AddSysLog(descrption = "更新DictCategory")
     public R update(@CurrentUser@ApiIgnore SysUser sysUser,@RequestBody @Valid DictCategory entity){
       return service.updateDictCategoryById(entity);
     }
}
